...
public class EclipseIntegrationsMcpServer
{
    ...
    @Tool(name = "createProject", description = "Create a new Eclipse project scaffold from prompt. Supports gradle or maven build tools.", type = "object")
    public String createProject(
            @ToolParam(name = "projectName", description = "Project name to create", required = true) String projectName,
            @ToolParam(name = "buildTool", description = "Build tool: gradle or maven (default: gradle)", required = false) String buildTool,
            @ToolParam(name = "basePackage", description = "Base package name (e.g. com.example.demo)", required = false) String basePackage,
            @ToolParam(name = "prompt", description = "Natural language prompt with project requirements", required = false) String prompt,
            @ToolParam(name = "runBuild", description = "Whether to run workspace build after creation: true or false", required = false) String runBuild)
    {
        return projectService.createProject(projectName, buildTool, basePackage, prompt, runBuild);
    }
